...
abstract class LoopingPagerAdapter<T>(
    ...
    override fun getCount(): Int {
        ...
        return if (isInfinite && canInfinite) count + 2
        else count
    }
     ...
     */
    protected fun getItemViewType(listPosition: Int): Int = 0
    ...
    private fun getListPosition(position: Int): Int {
        ...
        return when {
            position == 0 -> count - 1 - 2 //First item is a dummy of last item
            position > count - 2 -> 0 //Last item is a dummy of first item
            else -> position - 1
        }
    }
